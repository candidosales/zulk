...
<?php  include('menu.php'); ?>
   ...
   <?php 
    ...
    ?>
      ...
      <div class="slide">
        <ul id="slide-1" data-orbit data-options="timer_speed:2500; navigation_arrows:false; slide_number:false;timer:false;">
        ...
        <li title="<?php the_title_attribute(); ?>">
          <a itemprop="photo" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" data-view="3" data-comment="17" data-favorite="50" data-date="<?php echo $diff->d ?>">
             <img title="<?php the_title_attribute(); ?>" src="<?php echo $thumb ?>"/>
          </a>
        </li>
        <?php 
              }
    ...
    ?>
      ...
      <div id="slide-2" class="slide">
        <ul data-orbit data-options="timer_speed:2500; navigation_arrows:false; slide_number:false;timer:false;">
          <?php
