;(function ($, window, undefined) {
  ...
  $("#slide-1").orbit({
    ...
    afterSlideChange: function(){
        ...
        var category = $(y).data('category');
        $(y).closest('.principal').find('.label-category-1').html(category);
  ...
  $("#slide-2").orbit({
   ...
   $('#slide-1, #slide-2').trigger('orbit.stop');

   $('#slide-1, #slide-2').on("mouseenter", function(){
      $(this).trigger('orbit.start');
      $(this).closest('.principal').find('.title-category-parent').fadeOut("slow");
      $(this).closest('.principal').find('.title-category-child-1, .label-category, .share-media').fadeToggle("fast","linear");
   }).on("mouseleave",function(){
      $(this).trigger('orbit.stop');
      $(this).closest('.principal').find('.title-category-parent').fadeIn("slow");
      $(this).closest('.principal').find('.title-category-child-1, .label-category, .share-media').fadeToggle("fast","linear");
   });

/****** Interações ******/

  /*$('.share-media').on("mouseenter",function(){
    $('.title-category-child-1, .label-category').fadeToggle("fast","linear");
    $('.title-category-parent').css("display","none");
  });*/
